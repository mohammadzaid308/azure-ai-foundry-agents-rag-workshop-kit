...
#      bakery-support-workflow to see the intake → specialist → synthesizer
...
#
#   3. Open the workflow's "Traces" tab (or the project "Tracing" page): the
#      run appears as one trace with nested spans per handoff (note span names
#      + durations). Prompt-agent tracing is GA; workflow tracing is preview.
# ──────────────────────────────────────────────────────────────────────────
